...
[
  ...
  },
  {
    ...
    "displayName": "Pixel ID(s) and API Access Token(s)",
    "simpleTableColumns": [
      {
        "defaultValue": "",
    ...
    "help": "In the first column, set the \u003cb\u003ePixel ID(s)\u003c/b\u003e column to a string of a single Facebook Pixel ID or multiple Facebook Pixel IDs separated by comma.\n\u003cbr\u003e\n\u003cbr\u003e\nExample: 1111111 or 1111111,222222,333333\n\u003cbr\u003e\n\u003cbr\u003e\n-\n\u003cbr\u003e\n\u003cbr\u003e\nIn the second column, set the \u003cb\u003eAPI Access Token(s)\u003c/b\u003e column to a string of a single API Access Token or multiple API Access Token separated by comma.\n\u003cbr\u003e\nSee \u003ca href\u003d\"https://developers.facebook.com/docs/marketing-api/server-side-api/get-started#access-token\" target\u003d\"_blank\"\u003ehere\u003c/a\u003e for more information.\n\u003cbr\u003e\n\u003cbr\u003e\nThe first API Access Token must be for the first Facebook Pixel ID, the second API Access Token must be for the second and so on.\n\u003cbr\u003e\n\u003cbr\u003e\nIf your API Access Token is the same for different Pixel IDs (i.e., they\u0027re all in the same Business Manager account), then you can only add it once instead of repeating the same value separated by comma.\n\u003cbr\u003e\n\u003cbr\u003e\nExample: abcd1234 or abcd1234,uuuuu22222,ae12io34"
  },
  {
    "type": "TEXT",
    "name": "testId",
